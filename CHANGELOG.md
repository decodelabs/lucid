...
### [v0.8.1](https://github.com/decodelabs/lucid/commits/v0.8.1) - 26th September 2025

- Fixed null checking in validation logic

[Full list of changes](https://github.com/decodelabs/lucid/compare/v0.8.0...v0.8.1)

---

### [v0.8.0](https://github.com/decodelabs/lucid/commits/v0.8.0) - 19th September 2025

- Removed Sanitizer interface
- Removed ValueContainer structure
- Simplified Provider processing logic

[Full list of changes](https://github.com/decodelabs/lucid/compare/v0.7.0...v0.8.0)

---

### [v0.7.0](https://github.com/decodelabs/lucid/commits/v0.7.0) - 18th September 2025

- Merged lucid-support package
- Use Slingshot to load Processors
- Replaced getters with property hooks in validate results
- Moved Date processor to Kairos package
- Added JSON processor
- Added In constraint to support array<mixed>
- Added array<type> format support
- Removed Dictum dependency
- Removed Carbon dependency
- Simplified CI workflow

[Full list of changes](https://github.com/decodelabs/lucid/compare/v0.6.1...v0.7.0)

---

### [v0.6.1](https://github.com/decodelabs/lucid/commits/v0.6.1) - 10th September 2025

- Upgraded Kingdom to v0.2

[Full list of changes](https://github.com/decodelabs/lucid/compare/v0.6.0...v0.6.1)
